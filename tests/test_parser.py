...
def test_valid_requirements():
    """Test parsing a valid requirements dictionary lists."""
    data = [
...
def test_missing_parent_validation():
    """Verify missing parents fail gracefully."""
    data = [{"id": "REQ-001", "title": "Req 1", "derived_from": ["SYS-999"]}]
...
def test_cyclic_dependency_validation():
    """Verify cyclical dependencies fail validation gracefully."""
    data = [
...
def test_duplicate_id_validation():
    """Verify duplicate IDs fail validation gracefully."""
    data = [
